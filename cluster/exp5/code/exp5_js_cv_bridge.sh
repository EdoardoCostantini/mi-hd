...
# Title: 	lisa job script for experiment 5 (single job type)
# Partitioning: short
# Author:	Edoardo Costantini
# Date:		2021-03-16

## USAGE on LISA:
##   sbatch exp5_js_cv_bridge.sh
##
## NOTES:
...
idGoal=exp5_cv_bridge		# Goal of simulation
...
(
	...
	Rscript $inDir/exp5_simScript_cv_bridge.R $STOPOS_VALUE $tmpOut/
