### Title:    Initialization scirpt parameter for experiment 5 (addendum)
...
# Data gen ----------------------------------------------------------------
  parms$n_obs <- 5e2 # 5e2 # number of cases for data generation
  parms$n <- 5e2 # 5e2 number of cases for data generation
