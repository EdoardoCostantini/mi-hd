...
for (r in 1:reps) {
    # Drop unused methods
    out_cnv[[r]][[1]]$imp_values <- out_cnv[[r]][[1]]$imp_values[!grepl("stepFor", names(out_cnv[[r]][[1]]$imp_values))]
...
out_cnv <- saveRDS(mids_r, "../output/exp1_2_convergence_all_meth_20230403_1027_shiny.rds")
