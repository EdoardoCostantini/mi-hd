...
parms$dt_rep     <- 2 # 10 # not really used in the lisa framework
parms$chains     <- 2  # 5  # number of chains for convergence check
parms$iters      <- 2 # 500 
...
conds <- conds[1, ]
  # you can allow yourself to check convergence only on the difficult
  # condition
